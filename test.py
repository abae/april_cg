...
def getHand(xHand, yHand, threshold=170):
    ...
    for rank_contour in rank_contours:
        ...
        if text:
            ...
            print(f"failed to find see contour {sys.argv[1]} try again")
    ...
    if hand[1] > 20:
        ...
        if checkForButton("hit"):
            return getHand(xHand,yHand, threshold+random.randrange(-10,10))
        else:
            return 
    return hand
